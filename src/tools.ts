...
// --- Schema helpers ---
const s = (d: string) => ({ type: "string" as const, description: d });
const i = (d: string) => ({ type: "integer" as const, description: d });
const n = (d: string) => ({ type: "number" as const, description: d });
const b = (d: string) => ({ type: "boolean" as const, description: d });
const sa = (d: string) => ({
  type: "array" as const,
...
const telObjArray = (d: string) => ({
  type: "array" as const,
  items: {
    type: "object" as const,
    properties: { tel: { type: "string" as const } },
    required: ["tel"],
  },
  description: d,
});
...
export const allTools: ToolDef[] = [
  // ===== 1. Customer (8) =====
  {
    ...
    description:
      "Re:lation のコンタクト（顧客）を検索します。各種条件で絞り込みが可能です。per_page最大50。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "Re:lation に新しいコンタクトを登録します。⚠ データを作成します。実行前に内容を確認してください。",
    safety: "write",
    method: "POST",
  ...
  },
  {
    ...
    description:
      "外部システムIDをキーにコンタクト情報を更新します。⚠ データを変更します。空配列でemails/tels/badge_ids削除。",
    safety: "write",
    method: "PUT",
  ...
  },
  {
    ...
    description:
      "メールアドレスをキーにコンタクト情報を更新します。⚠ データを変更します。空配列でemails/tels/badge_ids削除。",
    safety: "write",
    method: "PUT",
  ...
  },
  {
    ...
    description:
      "外部システムIDを指定してコンタクトを削除します。⚠⚠ 破壊的操作です。削除は取り消せません。実行前に必ずユーザーに確認してください。",
    safety: "dangerous",
    method: "DELETE",
    path: "/customer_groups/:customer_group_id/customers/system_id1/:system_id1",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "メールアドレスを指定してコンタクトを削除します。⚠⚠ 破壊的操作です。削除は取り消せません。実行前に必ずユーザーに確認してください。",
    safety: "dangerous",
    method: "DELETE",
    path: "/customer_groups/:customer_group_id/customers/email/:email",
    inputSchema: {
  ...
  // ===== 3. Ticket (4) =====
  {
    ...
    description:
      "チケットを検索します。ステータス、ラベル、担当者、チャネル種別、日時範囲等で絞り込みが可能です。per_page最大50。",
    safety: "read",
    method: "POST",
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status_cds: sa(
          "ステータスコード配列（open/ongoing/closed/unwanted/trash/spam）",
        ),
        color_cds: sa(
          "色コード配列（red/orange/yellow/blue/pink）",
        ),
        assignee: s("担当者メンション名で絞り込み"),
        message_ids: ia("メッセージID配列で絞り込み"),
        has_attachments: b("添付ファイルありで絞り込み"),
        method_cds: sa(
          "チャネル種別配列（mail/tweet/twitter_dm/record/line/chatplus/r_messe/yahoo/sms/call）",
        ),
        action_cds: sa(
          "アクション種別配列（received/sent/draft/requested/approved/rejected/sending/scheduled/send_error/conversation/end_conversation）",
        ),
  ...
  },
  {
    ...
    description:
      "チケットの詳細情報を取得します。コメント・添付ファイル情報を含みます。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "応対メモ（電話・訪問・郵送等の記録）を作成します。⚠ データを作成します。実行前に内容を確認してください。",
    safety: "write",
    method: "POST",
    ...
    inputSchema: {
      ...
      properties: {
        ...
        subject: s("件名（必須）"),
        status_cd: s(
          "ステータスコード（デフォルト: closed）（open/ongoing/closed/unwanted/trash/spam）",
        ),
        ...
        icon_cd: s(
          "アイコン（デフォルト: received_phone）（received_phone/called_phone/meeting/sales/postal/note）",
        ),
  ...
  },
  {
    ...
    description:
      "チケットのステータス・担当者・ラベル・色・分類等を更新します。⚠ データを変更します。",
    safety: "write",
    method: "PUT",
    path: "/:message_box_id/tickets/:ticket_id",
    inputSchema: {
      ...
      properties: {
        ...
        ticket_id: i("チケットID"),
        status_cd: s(
          "ステータスコード（open/ongoing/closed/unwanted/trash/spam）",
        ),
        pending_reason_id: i("保留理由ID"),
        snooze_term: s(
          "スヌーズ期間（no_term/today/tomorrow/weekend/next_monday/next_week/next_month/after_month）",
        ),
  ...
  // ===== 4. Chat (4) =====
  {
    ...
    description:
      "ChatPlusの会話履歴を取得します。account, account_key, conversations情報を含みます。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "Yahoo!ショッピングの会話履歴を取得します。注文ID・商品情報を含みます。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "R-Messe（楽天）の会話履歴を取得します。注文番号・商品情報・ソーシャルギフト種別を含みます。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "LINEの会話履歴を取得します。channel_id, group_name, auto_send情報を含みます。",
    safety: "read",
    method: "GET",
  ...
  // ===== 6. Pending Reason (1) =====
  {
    ...
    description:
      "受信箱の保留理由一覧を取得します。スヌーズ復帰日時のコード体系も参照できます。",
    safety: "read",
    method: "GET",
  ...
  // ===== 7. User (1) =====
  {
    ...
    description:
      "ユーザー一覧を取得します。メールアドレス、管理者フラグ、多要素認証、最終アクセス日時を含みます。",
    safety: "read",
    method: "GET",
    path: "/users",
    inputSchema: {
  ...
  // ===== 8. Case Category (3) =====
  {
    ...
    description:
      "チケット分類の一覧を取得します。階層構造（親>子>孫）。per_page最大100。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "チケット分類を新規登録します。⚠ マスタデータを変更します。実行前に確認してください。",
    safety: "master",
    method: "POST",
    path: "/:message_box_id/case_categories",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "チケット分類を更新・アーカイブします。⚠ マスタデータを変更します。204 No Content。",
    safety: "master",
    method: "PUT",
  ...
  },
  {
    ...
    description:
      "ラベルを新規登録します。⚠ マスタデータを変更します。実行前に確認してください。",
    safety: "master",
    method: "POST",
    path: "/:message_box_id/labels",
    inputSchema: {
      ...
      properties: {
        ...
        color: s(
          "ラベルの色（必須）（gray/brown/red/orange/green/blue/purple + _01〜_04）",
        ),
        parent_id: i("親ラベルID"),
      },
  ...
  },
  {
    ...
    description:
      "ラベルを更新します。⚠ マスタデータを変更します。実行前に確認してください。",
    safety: "master",
    method: "PUT",
  ...
  // ===== 12. Mail (3) =====
  {
    ...
    description:
      "新規チケットを作成しメールを送信します。⚠⚠ 実際にメールが送信されます。実行前に必ずユーザーに確認してください。",
    safety: "dangerous",
    method: "POST",
    ...
    inputSchema: {
      ...
      properties: {
        ...mbId,
        status_cd: s(
          "ステータスコード（必須）（open/ongoing/closed/unwanted/trash/spam）",
        ),
        ...mailFields,
      },
      required: [
  ...
  },
  {
    ...
    description:
      "既存チケットのメッセージに返信します。⚠⚠ 実際にメールが送信されます。実行前に必ずユーザーに確認してください。",
    safety: "dangerous",
    method: "POST",
  ...
  },
  {
    ...
    description:
      "メールの下書きを作成します。message_id省略で新規チケットの下書き。⚠ データを作成します。",
    safety: "write",
    method: "POST",
  ...
  // ===== 13. Template (2) =====
  {
    ...
    description:
      "メールテンプレートの一覧を取得します。1ページ最大30件。html_body/text_bodyを含みます。",
    safety: "read",
    method: "GET",
  ...
  },
  {
    ...
    description:
      "テンプレートをカテゴリ名で検索します（完全一致）。per_page最大30。",
    safety: "read",
    method: "POST",
  ...
  // ===== 14. Comment (1) =====
  {
    ...
    description:
      "メッセージにコメントを追加します（最大1000文字）。⚠ データを作成します。実行前に内容を確認してください。",
    safety: "write",
    method: "POST",
  ...
  // ===== 15. Attachment (1) =====
  {
    ...
    description:
      "添付ファイルのダウンロードURL（Presigned URL）を発行します。有効期限付き。",
    safety: "read",
    method: "GET",
